...
|----|----------------|-----------|------------|
| F1 | Coleta de anúncios BGP | Agregação de streams de RIBs/updates de diversas fontes (RouteViews, RIPE, etc.) | Alta |
...
#### 11. **Front-end estático de demonstração**

Para agilizar protótipos, foram criadas páginas estáticas simples utilizando **Tailwind CSS via CDN** e ícones da biblioteca **Lucide**. Elas servem como base para o layout do painel e podem evoluir para os componentes reais do produto.

- `static/index.html` – Página inicial com navegação e ícone ilustrativo.
- `static/about.html` – Informação sobre o projeto.
- `static/contact.html` – Formulário de contato demonstrativo.
